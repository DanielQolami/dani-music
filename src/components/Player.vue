  ...
  >
    <div class="relative">
      ...
      <div class="float-left w-7 h-7 leading-3 ml-7 mt-2 player-scrub">
        <div
          class="absolute left-0 right-0 text-sm lg:text-lg text-center mx-auto player-song-info overflow-hidden"
          v-if="currentSong.modified_name"
        >
          <div class="scroll-text-auto">
...
export default {
  ...
  computed: {
    ...
    }), // because we're using vuex Modules
  },
  methods: {
